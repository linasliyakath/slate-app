...
export default function TaskForm({ onClose, onSuccess }: TaskFormProps) {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in duration-300">
            <h2 className="text-4xl font-light tracking-tight text-white mb-8">New Task</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex gap-4 pt-8 border-t border-zinc-900">
                    <button
                        ...
                        className="bg-white hover:bg-zinc-200 text-black px-8 py-3 rounded-none transition-all active:scale-95 font-bold tracking-widest text-xs uppercase disabled:opacity-50"
                    >
